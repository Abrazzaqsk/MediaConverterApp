locals {
  s3_origin_id = "MediaConvertOutputS3Origin"
}

resource "aws_cloudfront_origin_access_control" "oac" {
  name                              = "video-converter-oac"
  description                       = "OAC for video converter output bucket"
...
resource "aws_cloudfront_distribution" "cdn" {
  ...
  comment             = "CDN for converted videos"
  default_root_object = ""
...
resource "aws_s3_bucket_policy" "output_oac" {
